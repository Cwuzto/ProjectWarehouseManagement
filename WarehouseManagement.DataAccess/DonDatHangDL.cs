...
namespace WarehouseManagement.DataAccess
{
    public class DonDatHangDL
    {
        ...
        public bool THDDH(String MaDH,DateTime NgayDat , String MaNV)
        {
            int count = 0;
            var query = "INSERT INTO DonDatHang (MaDH, NgayDat, TrangThai, MaNV) VALUES ( @madh , @ngaydat , N'Chờ xác nhận' , @manv )";
            object[] parameters = { MaDH, NgayDat, MaNV };
